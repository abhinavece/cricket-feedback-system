  ...
  return (
    <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center pt-20">
        {/* AI Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-full mb-8 backdrop-blur-sm animate-fade-in">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-10">
          {['AI OCR Payments', 'Smart Availability', 'Auto Reminders', 'Match Analytics'].map((feature, i) => (
            <span 
              key={feature}
              className="px-3 py-1.5 bg-slate-800/50 border border-slate-700/50 rounded-full text-xs text-slate-400 backdrop-blur-sm flex items-center gap-1"
